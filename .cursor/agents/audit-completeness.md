...
description: Проверяет полноту контента по всем страницам курса. Вызывается скиллом quality-audit. Проверяет, что все блоки заполнены, нет заглушек, нет пустых обязательных полей.
model: fast
is_background: true
---
