...
description: >-
  Проверяет техническое качество YAML-файлов страниц курса.
  Вызывается скиллом quality-audit. Валидирует YAML-синтаксис,
  уникальность ID, обязательные поля, структуру по модели.
model: fast
is_background: true
---
