...
description: >-
  Методологический анализ и брифование на основе трёхосевой модели.
  Загружает ассеты по бизнес-драйверу (зачем), категории курса (что)
  и аудитории (для кого), проводит анализ, уточняет детали,
  собирает общие параметры и финализирует бриф.
---
