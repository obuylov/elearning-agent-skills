...
name: quality-audit
description: >-
  Оркестрация аудита качества курса через субагентов.
  Спрашивает пользователя: запустить все 5 проверок или конкретные.
  Каждая проверка — отдельный фоновый субагент. Используй после
  завершения генерации контента или когда пользователь просит провести
  аудит, ревью или проверку качества курса.
---
